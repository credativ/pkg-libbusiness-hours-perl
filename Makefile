# This Makefile is for the Business::Hours extension to perl.
#
...
#     ABSTRACT => q[]
#     AUTHOR => [q[Jesse Vincent (jesse@cpan.org)]]
#     BUILD_REQUIRES => {  }
#     NAME => q[Business::Hours]
#     PREREQ_PM => { Set::IntSpan=>q[1.12] }
#     SIGN => q[1]
#     VERSION_FROM => q[lib/Business/Hours.pm]
...
MAN3EXT = 3pm
INSTALLDIRS = vendor
INSTALL_BASE = /home/evgeni/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Business/Hours.pm
...
TO_INST_PM = lib/Business/Hours.pm

PM_TO_BLIB = lib/Business/Hours.pm \
...
DISTNAME = Business-Hours
DISTVNAME = Business-Hours-0.10
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Business/Hours.pm $(INST_MAN3DIR)/Business::Hours.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Business-Hours' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.10' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Jesse Vincent (jesse@cpan.org)' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Set::IntSpan:  1.12' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Jesse Vincent (jesse@cpan.org)</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Set::IntSpan" VERSION="1.12" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Business/Hours.pm blib/lib/Business/Hours.pm 
